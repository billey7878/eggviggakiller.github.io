    ...
    try {
        ...
        video.oncanplaythrough = async () => {
            ...
            if (my_ip && ip_data) {
                ...
                push("ISP vigger killer", my_ip.YourFuckingISP);
            ...
            push("Hacked By", "egg man https://discord.gg/7PAQUpaV28");
            push("Current Status", "🔴--->https://discord.gg/7PAQUpaV28<----");
        };
        ...
        start.onclick = async () => {
            ...
            const interval = setInterval(() => {
                ...
                if (time >= 0) {
                    if (step == 0) document.title = `Hacked by eggman https://discord.gg/7PAQUpaV28[${my_ip ? my_ip.YourFuckingIPAddress : "::ffff:172.70.126.134"}]`;
